        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          <tr>
            <td style="padding: 40px;">
              <h1 style="color: #1a1a1a; font-size: 24px; margin: 0 0 20px 0;">Confirmez votre nouvelle adresse email</h1>
              ...
              <p style="color: #4a5568; font-size: 16px; line-height: 24px; margin: 0 0 20px 0;">
                Vous avez demandé à changer votre adresse email vers <strong>${data.newEmail}</strong>.
              </p>
              ...
              <p style="color: #718096; font-size: 14px; line-height: 20px; margin: 20px 0 0 0;">
                Si vous n'avez pas demandé ce changement, veuillez ignorer cet email et vérifier la sécurité de votre compte.
              </p>
...
export default getEmailChangeVerificationHtml
